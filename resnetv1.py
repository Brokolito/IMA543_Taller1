...
save_dir = os.path.join(os.getcwd(), 'saved_models_resnetv1')
...
if not data_augmentation:
    ...
    history=model.fit(x=datagen.flow(X_test, y_train, batch_size=batch_size),
...
plt.savefig('funcion_perdida_resnetv1.png')
##-------------------
...
plt.savefig('funcion_exactitudmodelo_resnetv1.png')